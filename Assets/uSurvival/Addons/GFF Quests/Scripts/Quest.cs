...
namespace uSurvival
{
    ...
    public partial struct Quest
    {
        ...
        //public string lastTimeCompleted;
        public DateTime lastTimeCompleted;
        ...
        public Quest(ScriptableQuest data)
        {
            ...
            progress = 0;
            completed = false;
            lastTimeCompleted = new DateTime();
        }
        ...
        public ushort rewardCoins => data.rewardCoins;
        public ScriptableItemAndAmount[] rewardItems => data.rewardItems;

        public short cooldown => data.cooldown;
        public bool guild => data.guild;
        ...
        public string ToolTip(Player player)
        {
            ...
            // addon system hooks
            UtilsExtended.InvokeMany(typeof(Quest), this, "ToolTip_", tip);
