...
namespace GFFAddons
{
    public abstract class PlayerOffer : NetworkBehaviour
    {
        ...
        public abstract string GetOfferName(Player player);

        // called when the player clicks the offer button
        public abstract void OnSelect(Player player, Player target);
    }
}
