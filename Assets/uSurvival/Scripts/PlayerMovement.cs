...
namespace uSurvival
{
    ...
    #pragma warning restore CS0109 // member does not hide accessible member
        ...
        [Header("Crouching")]
        public float crouchSpeedDefault = 1.5f;
        public KeyCode crouchKey = KeyCode.C;
        bool crouchKeyPressed;

        [Header("Crawling")]
        public float crawlSpeedDefault = 1;
        ...
        {
            camera = Camera.main;
            moveSpeedBonusComponents = GetComponentsInChildren<IMoveSpeedBonus>();
        }
        ...
        Vector2 GetInputDirection()
        {
            ...
            float horizontal = 0;
            float vertical = 0;
            if (!UIUtils.AnyInputActive() && joystick!=null)
            {
        ...
        void ApplyFallDamage()
        {
            ...
            {
                short damage = (short)Mathf.RoundToInt(fallMagnitude * fallDamageMultiplier);
        ...
        MoveState UpdateCROUCHING(Vector2 inputDir, Vector3 desiredDir)
        {
            ...
            float crouchSpeed = crouchSpeedExtended;
        ...
        MoveState UpdateCRAWLING(Vector2 inputDir, Vector3 desiredDir)
        {
            ...
            float crawlSpeed = crawlSpeedExtended;
        ...
        float GetMaximumSpeedForState(MoveState moveState)
        {
            switch (moveState)
            {
                ...
                case MoveState.CRAWLING:
                    return crawlSpeedExtended;
                case MoveState.CROUCHING:
                    return crouchSpeedExtended;
        ...
        void FixedUpdate()
        {
            ...
            if (isServer)
            {
                ...
                {
                    if (player == null || player.gameMasterTool.immortality == false) ApplyFallDamage();
                }
            }
