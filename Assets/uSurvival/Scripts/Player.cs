...
namespace uSurvival
{
    ...
    public partial class Player : Entity
    {
        ...
        //gff
        public GameObject[] objectsForZoomSetup;
        ...
        public override void OnStartLocalPlayer()
        {
            ...
            GameObject miniMap = GameObject.FindWithTag("MinimapCamera");
            if (miniMap) miniMap.GetComponent<CopyPosition>().target = transform;
        }
        ...
        public override void OnStartClient()
        {
            ...
            for (int i = 0; i < objectsForZoomSetup.Length; i++)
            {
                ExtensionsExtended.SetLayerRecursively(objectsForZoomSetup[i].gameObject, 24);
            }
        }
        ...
        void LateUpdate()
        {
            ...
            foreach (Animator animator in GetComponentsInChildren<Animator>())
            {
                ...
                animator.SetBool("UPPERBODY_HANDS", equipment.slots[equipment.selection].amount == 0);
                ...
                if (movement.state != MoveState.CLIMBING && // not while climbing
                    equipment.slots[equipment.selection].amount > 0 &&
                    equipment.slots[equipment.selection].item.data is WeaponItem)
                {
                    WeaponItem weapon = (WeaponItem)equipment.slots[equipment.selection].item.data;
