    ...
    public class UILogin : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (manager.state == NetworkState.Offline || manager.state == NetworkState.Handshake)
            {
                ...
                Debug.Log("networactive "+manager.isNetworkActive + " isallowedaccountname "+auth.IsAllowedAccountName(accountInput.text));
                ...
                serverDropdown.options = manager.serversList.Select(
