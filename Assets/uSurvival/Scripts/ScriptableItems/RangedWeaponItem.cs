...
namespace uSurvival
{
    public abstract partial class RangedWeaponItem : WeaponItem
    {
        ...
        // helper functions ////////////////////////////////////////////////////////
        public WeaponDetails GetWeaponDetails(PlayerEquipment equipment)
        {
        ...
        public override string ToolTip()
        {
            ...
            tip.Replace("{REQUIREDAMMO}", GetCompatibleAmmoForToolTip());
