...
namespace uSurvival
{
    ...
    public partial class MeleeWeaponItem : WeaponItem
    {
        ...
        //public override void UseHotbar(Player player, int equipmentIndex, Vector3 lookAt)
        //{
        //    // call base function to start cooldown
        //    base.UseHotbar(player, equipmentIndex, lookAt);
